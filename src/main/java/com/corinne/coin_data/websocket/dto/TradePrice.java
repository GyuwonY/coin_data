...
public class TradePrice {
    ...
    public int change_price; // 부호 없는 전일 대비 값
    public int signed_change_price; // 전일 대비 값
    public int change_rate; // 부호 없는 전일 대비 등락율
    public int signed_change_rate; // 전일 대비 등락율
    ...
    public int highest_52_week_price; // 52주 최고가
    public String highest_52_week_date; // 52주 최고가 달성일
    public int lowest_52_week_price; // 52주 최저가
